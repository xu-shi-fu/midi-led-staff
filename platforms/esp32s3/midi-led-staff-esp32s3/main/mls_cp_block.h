...
mls_cp_block_array_entity *mls_cp_block_array_entity_create(uint capacity);
...
mls_error mls_cp_block_array_create(mls_cp_block_array *buffer, uint capacity);
...
mls_error mls_cp_block_array_holder_create(mls_cp_block_array_holder *holder, uint capacity);
