module github.com/xu-shi-fu/midi-led-staff/platforms/golang/mls-cp-stack

go 1.21.6

require github.com/starter-go/starter v1.0.12
...
require (
	...
	github.com/starter-go/libgin v1.0.17 // indirect
