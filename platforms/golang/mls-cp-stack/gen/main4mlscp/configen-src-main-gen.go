...
// type p9a99ad5d3.TestController in package:github.com/xu-shi-fu/midi-led-staff/platforms/golang/mls-cp-stack/app/web/controllers
//
// id:com-9a99ad5d3031ef6f-controllers-TestController
// class:class-d1a916a203352fd5d33eabc36896b42e-Controller
// alias:
// scope:singleton
//
type p9a99ad5d30_controllers_TestController struct {
}

func (inst* p9a99ad5d30_controllers_TestController) register(cr application.ComponentRegistry) error {
	r := cr.NewRegistration()
	r.ID = "com-9a99ad5d3031ef6f-controllers-TestController"
	r.Classes = "class-d1a916a203352fd5d33eabc36896b42e-Controller"
	r.Aliases = ""
	r.Scope = "singleton"
	r.NewFunc = inst.new
...
func (inst* p9a99ad5d30_controllers_TestController) new() any {
    return &p9a99ad5d3.TestController{}
}

func (inst* p9a99ad5d30_controllers_TestController) inject(injext application.InjectionExt, instance any) error {
	ie := injext
	com := instance.(*p9a99ad5d3.TestController)
	nop(ie, com)
